...
public class Raymarcher : MonoBehaviour
{
    ...
    [SerializeField, Range(5, 7)] float _width;
    [SerializeField, Range(5, 10)] float _depth;
    [SerializeField, Range(7, 32)] float _windowSize;
    [SerializeField, Range(-2, 2)] float _windowPos;
    ...
    void Update()
    {
        ...
        _raymarchingShader.SetFloat("_windowSize", _windowSize);
        _raymarchingShader.SetFloat("_windowPos", _windowPos);
