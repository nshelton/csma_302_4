...
public class Raymarcher : MonoBehaviour
{
    ...
    [Range(1,12)]
    public int floorCount = 8; // 33 is laggy lmao
    ...
    void Update()
    {
        ...
        _raymarchingShader.SetInt("_floorCount", floorCount);
        _raymarchingShader.SetVector("_wallColor", wallColor);
        _raymarchingShader.SetVector("_groundColor", groundColor);
        _raymarchingShader.SetFloat("_windowWidth", windowWidth);
        _raymarchingShader.SetFloat("_rotationAmount", rotationAmount);
        ...
        _raymarchingShader.SetVector("_Time", Shader.GetGlobalVector("_Time"));
